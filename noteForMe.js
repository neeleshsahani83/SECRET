...
app.post("/register", function(req, res) {
    ...
    newUser.save()
      .then(() => {
        // If the user is registered, render the secret page
        res.render("Secrets");
      })
      .catch((err) => {
        console.log(err);
...
//now level 2 encryption it involves authentication
// mongoose-encryption  uses AES-256-CBC
...
/////////////////////////////////////
//////////////////////////
// hashing and salting ==> prvent hash table crack and dictionary attack
// Salting

// password + random char  ==> hash function ==> hash
//bcrypt
